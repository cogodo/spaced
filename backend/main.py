...
from core.monitoring.logger import get_logger, setup_logging
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description=(
            "AI-powered spaced repetition learning system with production monitoring"
        ),
        version="1.0.0",
        docs_url="/docs",
        redoc_url="/redoc",
    ...
    async def startup_event():
        ...
        try:
            ...
            logger.info(
                "Learning Chatbot API startup completed",
                features_enabled=[
                    "structured_logging",
