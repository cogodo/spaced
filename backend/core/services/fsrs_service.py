...
try:
    from fsrs import Card, Rating, State, FSRS as FSRSScheduler
except ImportError:
...
class FSRSService:
    ...
    def calculate_next_review(
        ...
        try:
            ...
            return {
                "nextReviewAt": getattr(next_card, 'due', datetime.now() + timedelta(days=updated_params.interval)),
    ...
    def _fallback_calculation(self, current_params: FSRSParams, performance_score: int, last_review: Optional[datetime]) -> Dict[str, Any]:
