...
from .metrics import get_metrics, set_gauge, observe_histogram
...
class PerformanceTracker:
    ...
    def _check_thresholds(self, snapshot: ResourceSnapshot):
        ...
        if snapshot.cpu_percent > self.cpu_threshold:
            ...
            logger.warning("Performance alert: High CPU usage", 
        ...
        if snapshot.memory_percent > self.memory_threshold:
            ...
            self.alerts.append(alert)
            logger.warning("Performance alert: High memory usage",
