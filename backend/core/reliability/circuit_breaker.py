...
class CircuitBreaker:
    ...
    def call(self, func: Callable, *args, **kwargs) -> Any:
        ...
        with self._lock:
            ...
            if self.state == CircuitBreakerState.OPEN:
                ...
                increment_counter("circuit_breaker_calls_rejected", 
    ...
    def _record_success(self, duration: float):
        ...
        increment_counter("circuit_breaker_calls_success", 
                        {"circuit_breaker": self.name})
    ...
    def _record_failure(self, duration: float):
        ...
        increment_counter("circuit_breaker_calls_failure", 
                        {"circuit_breaker": self.name})
    ...
    def _transition_to_open(self):
        ...
        increment_counter("circuit_breaker_state_changes", 
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            recent_calls = [
                ...
                if (datetime.utcnow() - call["timestamp"]).total_seconds() < 300  # Last 5 minutes
            ]
            
            total_calls = len(recent_calls)
            success_calls = len([c for c in recent_calls if c["result"] == "success"])
            failure_calls = len([c for c in recent_calls if c["result"] == "failure"])
            rejected_calls = len([c for c in recent_calls if c["result"] == "rejected"])
            ...
            return {
                ...
                "recent_metrics": {
                    ...
                    "success_calls_5min": success_calls,
                    "failure_calls_5min": failure_calls,
                    "rejected_calls_5min": rejected_calls,
