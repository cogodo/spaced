...
class TopicRepository:
    ...
    def get_by_id(self, topic_id: str, user_uid: str) -> Optional[Topic]:
    ...
    def list_by_owner(self, owner_uid: str) -> List[Topic]:
