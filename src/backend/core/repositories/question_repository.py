...
class QuestionRepository:
    ...
    def create(self, question: Question, user_uid: str) -> Question:
    ...
    def get_by_id(self, question_id: str, user_uid: str, topic_id: str) -> Optional[Question]:
    ...
    def list_by_topic(self, topic_id: str, user_uid: str, limit: int = 50) -> List[Question]:
    ...
    def update(self, question_id: str, user_uid: str, topic_id: str, updates: dict) -> None:
    ...
    def delete(self, question_id: str, user_uid: str, topic_id: str) -> None:
    ...
    def delete_by_topic(self, topic_id: str, user_uid: str) -> None:
    ...
    def create_batch(self, questions: List[Question], user_uid: str) -> None:
